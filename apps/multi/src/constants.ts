...
export const peerOptions = { host: import.meta.env.VITE_PEER_HOST || '/', secure: import.meta.env.VITE_PEER_SECURE === 'true' || false, port: parseInt(import.meta.env.VITE_PEER_PORT || '9000') }